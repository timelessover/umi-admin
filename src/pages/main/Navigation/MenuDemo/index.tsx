...
const MenuDemo = ()=> {
  ...
  const changeMode = (checked:string) => {
    setMode(checked ? 'inline' : 'horizontal')
  }
              ...
              <Row type='flex' align='middle'>
                <Col span={12}>
                  <Menu mode="inline" style={{width: 200}}>
                    ...
                    <Menu.Item key="app" disabled={true}><Icon type="appstore"/>Navigation Two</Menu.Item>
          ...
          <Col span={12}>
            ...
            <Card bordered={false} className='card-item'>
              <p style={{paddingLeft: 15}}>
                <Switch size='small' onChange={changeMode}/> Change Mode &emsp;
                <Switch size='small' onChange={changeTheme}/> Change Theme
              </p>
